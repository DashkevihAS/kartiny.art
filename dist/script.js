...
var accordion = function accordion(triggerSelector, contentSelector) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menuElement, menuBurger) {
  var menu = document.querySelector(menuElement),
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      ...
      resultBlock.textContent = "".concat(sum * 0.7);
    } else {
...
var filter = function filter() {
  ...
  var showFilterItems = function showFilterItems(markedItems) {
  ...
  menu.addEventListener('click', function (e) {
    ...
    var selectClass = e.target.classList[0],
        filterItems = wrapper.querySelectorAll(".".concat(selectClass));
...
var pictureSize = function pictureSize(pictureSelector) {
  var blocks = document.querySelectorAll(pictureSelector);

  var showPicture = function showPicture(block) {
  ...
  var hidePicture = function hidePicture(block) {
    var img = block.querySelector('img');
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var btn = document.querySelector(trigger); // Если карточки созданы в верстке
  // cards.forEach(card => {
